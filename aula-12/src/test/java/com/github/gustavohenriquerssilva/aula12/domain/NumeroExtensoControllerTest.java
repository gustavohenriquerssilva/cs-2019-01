...
public class NumeroExtensoControllerTest {
    ...
    public void especiaisTest() {
        ...
        assertEquals(new NumeroDTO("cento e doze").getNumero(),
                NumeroExtensoController.numeroExtenso("112").getNumero());
        assertEquals(new NumeroDTO("mil e dezesseis").getNumero(),
                NumeroExtensoController.numeroExtenso("1016").getNumero());
    ...
    public void doisDigitosTest() {
        ...
        assertEquals(new NumeroDTO("trinta e seis").getNumero(),
                NumeroExtensoController.numeroExtenso("36").getNumero());
    ...
    public void tresDigitosTest() {
        ...
        assertEquals(new NumeroDTO("cento e vinte").getNumero(),
                NumeroExtensoController.numeroExtenso("120").getNumero());
        assertEquals(new NumeroDTO("cento e vinte e dois").getNumero(),
                NumeroExtensoController.numeroExtenso("122").getNumero());
    ...
    public void quatroDigitosTest() {
        ...
        assertEquals(new NumeroDTO("dois mil e um").getNumero(),
                NumeroExtensoController.numeroExtenso("2001").getNumero());
        assertEquals(new NumeroDTO("três mil e vinte").getNumero(),
                NumeroExtensoController.numeroExtenso("3020").getNumero());
        assertEquals(new NumeroDTO("quatro mil e vinte e um").getNumero(),
                NumeroExtensoController.numeroExtenso("4021").getNumero());
        assertEquals(new NumeroDTO("quatro mil e cento e vinte e um").getNumero(),
                NumeroExtensoController.numeroExtenso("4121").getNumero());
        assertEquals(new NumeroDTO("mil e doze").getNumero(),
                NumeroExtensoController.numeroExtenso("1012").getNumero());
        assertEquals(new NumeroDTO("cento e um").getNumero(),
                NumeroExtensoController.numeroExtenso("0101").getNumero());
    ...
    public void entradasInvalidas() {
        assertThrows(IllegalArgumentException.class, () -> NumeroExtensoController.numeroExtenso("-100"));
        assertThrows(IllegalArgumentException.class, () -> NumeroExtensoController.numeroExtenso("abcd"));
